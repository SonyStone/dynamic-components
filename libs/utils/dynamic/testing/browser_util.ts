...
export class BrowserDetection {
  ...
  get supportsNativeIntlApi(): boolean {
    return !!(global as any).Intl && (global as any).Intl !== (global as any).IntlPolyfill;
  }
  ...
  get supportsCustomElements() { return (typeof(global as any).customElements !== 'undefined'); }
...
export function supportsWebAnimation(): boolean {
  return typeof(Element as any).prototype.animate === 'function';
}
